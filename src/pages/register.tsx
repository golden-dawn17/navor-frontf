...
import { UserAuthFormRegister } from "@/components/register/user-auth-register"

export default function IndexPage() {
  return (
    <section className="grid items-center gap-6" style={{height:"100vh",justifyContent:"center"}}>
